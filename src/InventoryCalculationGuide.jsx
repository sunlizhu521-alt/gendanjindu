    ...
    <section className="inventory-methodology">
      ...
      <aside className="inventory-methodology-pending" aria-label="不可售库存口径">
        ...
        <div>
          ...
          <p>原始仓库或映射后的金蝶仓库编码以333、555、777开头，仓库名称任意位置包含023，或名称为“（杭州）电子成品仓”时，不区分销售产品分类，全部归入不可售库存。</p>
          <p>其他仓库名称含“退货”时，商品分类维度SKU包含RE或K1的归入成品，其余归入不可售；333、555、777、023及“（杭州）电子成品仓”规则优先。</p>
