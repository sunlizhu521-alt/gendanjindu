...
const rows = [
  { projectName: 'A床项目', businessUnit: '国内事业部', projectStage: '测试', projectStatus: '进行中', productPositioning: '中端', owner: '张三', demandInitiationDate: '2026-08-20', sku: 'A1', weeklyMeetingNote: '技术评审' },
  { projectName: 'B椅项目', businessUnit: '海外事业一部', projectStage: '立项', projectStatus: '规划', productPositioning: '高端', owner: '李四', demandInitiationDate: '2026-09-10', sku: 'B1' }
];
